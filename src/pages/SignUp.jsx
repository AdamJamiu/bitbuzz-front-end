    ...
    return (
        <div className="w-full font-space-mono grid grid-cols-1 md:grid-cols-2 object-contain bg-bottom relative">
            <form onSubmit={handleSubmit} className="bg-white px-5 py-10 sm:p-20 md:py-10 md:px-28 overflow-y-auto h-full flex flex-col justify-center items-start">
                <h1 className="font-semibold text-2xl md:text-3xl text-app-black mb-4">Register to Bitbuzz</h1>

                <input placeholder="User Name" type="text" className="placeholder:text-app-black placeholder:font-medium w-full p-3 font-space-mono border-app-black border rounded-lg my-4" />
                ...
                <div className="w-full text-center mt-5">Already have an account? <Link className="font-semibold" to="/auth/login">Log In</Link></div>
            </form>
